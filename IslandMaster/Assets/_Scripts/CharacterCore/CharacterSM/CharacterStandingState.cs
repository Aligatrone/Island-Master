...
namespace _Scripts.CharacterCore.CharacterSM
{
	public class CharacterStandingState : CharacterBaseState
	{
		...
		public CharacterStandingState(CharacterStateMachine currentContext, CharacterStateFactory playerStateFactory) : base(currentContext, playerStateFactory){}
		...
		protected override void CheckSwitchStates()
		{
			...
			if(Context.drawWeaponAction.triggered && Context.playerEquipmentSystem.weapon != null)
			{
				SwitchState(Factory.Combat());
			}

			if(Context.crouchAction.triggered)
			{
